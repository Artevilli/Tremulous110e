...
<html>
<p>
This client aims to be fully compatible with Tremulous 1.1.0 mods
...
<li><b>\com_affinityMask</b> - bind Tremulous 1.1.0e process to bitmask-specified CPU core(s)</li>
...
<li>set <b>sv_dlURL</b> cvar to download location, for example:<br>
	&nbsp;<b>sets sv_dlURL "ftp://myftp.com/games/tremulous"</b><br>
...
&nbsp;&nbsp;<b>1</b> - save in fs_basegame (base) directory<br>
<br>
<hr>
<p> <b>Built-in URL-filter</b><br><br>
There is ability to launch Tremulous 1.1.0e client directly from your browser
by just clicking on URL that contains <b>tremulous://</b>
instead of usual <b>http://</b> or <b>ftp://</b> protocol headers<br><br>

What you need to do:
<ul>
<li>copy <b>tremurl_add.cmd</b>/<b>tremurl_rem.cmd</b> in tremulous.exe directory </li>
<li>run <b>tremurl_add.cmd</b> if you want to add protocol binding or <b>tremurl_add.cmd</b> if you want to remove it</li>
<li>type in your browser <a href="tremulous://127.0.0.1"><b>tremulous://</b>127.0.0.1</a> and follow it - if you see tremulous launching and trying to connect then everything is fine
</li>
</ul>
<br>
<hr>
...
In order to use this functionality you need to install ffmpeg package (on linux) or put ffmpeg binary near tremulous executable (on windows).<br>
<br>
