...
Install Visual Studio Community Edition 2017 or later and compile `tremulous` project from solution

`code/win32/msvc2017/tremulous.sln`

Copy resulting exe from `code/win32/msvc2017/output` directory

To compile with Vulkan backend - clean solution, right click on `tremulous` project, find `Project Dependencies` and select `renderervk` instead of `renderer`
