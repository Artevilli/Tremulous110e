...
typedef struct {
	...
	qint						numDrawSurfCmds;
	qint						lastRenderCommand;
	qint						numFogs; // read before parsing shaders
#endif
...
void R_ComputeColors( const qint bundle, color4ub_t *dest, const shaderStage_t *pStage );
...
void	RB_CalcEnvironmentTexCoordsFP( float *dstTexCoords, qint screenMap );
