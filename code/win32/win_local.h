...
void
Sys_CreateConsole(const qchar *title, qint xPos, qint yPos, qbool usePos);
void
...
void
IN_Activate(qbool active);
void
IN_Frame(void);

void
IN_UpdateWindow(RECT *window_rect, qbool updateClipRegion);
void
UpdateMonitorInfo(const RECT *target);
...
void
Conbuf_BeginPrint(void);
void
Conbuf_EndPrint(void);

void
SNDDMA_Activate(void);
