...
qbool   textureBorderClampAvailable;
qint			maxAnisotropy;
qint			gl_version;
...
static void R_Register( void )
{
	...
	ri.Cvar_SetDescription( r_mergeLightmaps, "Merge built-in small lightmaps into bigger lightmaps (atlases). Required \\r_ext_texture_border_clamp" );
