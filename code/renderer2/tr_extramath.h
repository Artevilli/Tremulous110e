...
typedef qint ivec2_t[2];
typedef qint ivec3_t[3];
typedef qint ivec4_t[4];
...
static ID_INLINE qint VectorCompare4(const vec4_t v1, const vec4_t v2)
{
...
static ID_INLINE qint VectorCompare5(const vec5_t v1, const vec5_t v2)
{
