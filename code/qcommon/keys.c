...
*/
void
Key_KeynameCompletion(void(*callback)(const qchar *s))
{
  qint i;
...
*/
static void
Key_CompleteBind(const qchar *args, qint argNum)
{
  const qchar *p;
...
*/
static void
Key_CompleteUnbind(const qchar *args, qint argNum)
{
  if (argNum == 2)
  {
    //skip "unbind "
