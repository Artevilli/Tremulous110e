...
//forced double-precision functions
...
static ID_INLINE double
DotProductDPf(const float *v1, const float *v2)
{
  double x[3];
  double y[3];
...
CrossProductDP(const vec3_t v1, const vec3_t v2, vec3_t cross)
{
  double d1[3];
  double d2[3];
