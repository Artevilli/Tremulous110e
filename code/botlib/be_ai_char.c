...
{
	qchar type;						//characteristic type
...
// Changes Globals:		-
//========================================================================
static bot_character_t *BotCharacterFromHandle(qint handle)
{
...
// Changes Globals:		-
//===========================================================================
static bot_character_t *BotReferenceHandle( qint handle, qint refmod )
{
	bot_character_t *ch;
...
// Changes Globals:		-
//========================================================================
static void BotFreeCharacter2(qint handle)
{
	if (handle <= 0 || handle > MAX_HANDLES)
	{
		botimport.Print(PRT_FATAL, "character handle %d out of range\n", handle);
...
// Changes Globals:		-
//========================================================================
void BotFreeCharacter( qint handle )
{
	bot_character_t *ch;
...
// Changes Globals:		-
//========================================================================
static qint BotReleaseUnreferencedHandle( void )
{
...
static void BotDefaultCharacteristics(bot_character_t *ch, bot_character_t *defaultch)
{
	...
	for (i = 0; i < MAX_CHARACTERISTICS; i++)
	{
		...
		else if (defaultch->c[i].type == CT_STRING)
		{
			...
			ch->c[i].value.string = (qchar *) GetMemory(strlen(defaultch->c[i].value.string)+1);
...
// Changes Globals:		-
//===========================================================================
static bot_character_t *BotLoadCharacterFromFile(const qchar *charfile, qint skill)
{
	qint indent, index, foundcharacter;
	bot_character_t *ch;
	source_t *source;
	token_t token;
	...
	while(PC_ReadToken( source, &token))
	{
		if (!strcmp(token.string, "skill"))
		{
			...
			if (skill < 0 || (qint)token.intvalue == skill)
			{
...
// Changes Globals:		-
//===========================================================================
static qint BotFindCachedCharacter(const qchar *charfile, float skill)
{
	qint handle;
...
// Changes Globals:		-
//===========================================================================
static qint BotLoadCachedCharacter(const qchar *charfile, float skill, qint reload)
{
	qint handle, cachedhandle, intskill;
...
// Changes Globals:		-
//===========================================================================
static qint BotLoadCharacterSkill(const qchar *charfile, float skill)
{
	qint ch, defaultch;
...
// Changes Globals:		-
//===========================================================================
static qint BotInterpolateCharacters(qint handle1, qint handle2, float desiredskill)
{
	...
	for (i = 0; i < MAX_CHARACTERISTICS; i++)
	{
		...
		else if (ch1->c[i].type == CT_STRING)
		{
			...
			out->c[i].value.string = (qchar *) GetMemory(strlen(ch1->c[i].value.string)+1);
...
{
	qint firstskill, secondskill, handle;
...
// Changes Globals:		-
//===========================================================================
static qint CheckCharacteristicIndex(qint character, qint index)
{
	bot_character_t *ch;
...
qint Characteristic_Integer(qint character, qint index)
{
	...
	{
		return (qint) ch->c[index].value._float;
	} //end else if
	else
	{
