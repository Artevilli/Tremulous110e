...
// Changes Globals:		-
//===========================================================================
qint AAS_UpdateEntity(qint entnum, bot_entitystate_t *state)
{
	qint relink;
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
void AAS_EntityInfo(qint entnum, aas_entityinfo_t *info)
{
...
// Changes Globals:		-
//===========================================================================
void AAS_EntityOrigin(qint entnum, vec3_t origin)
{
	if (entnum < 0 || entnum >= aasworld.maxentities)
	{
...
// Changes Globals:		-
//===========================================================================
qint AAS_EntityModelindex(qint entnum)
{
	if (entnum < 0 || entnum >= aasworld.maxentities)
	{
...
// Changes Globals:		-
//===========================================================================
qint AAS_EntityType(qint entnum)
{
...
// Changes Globals:		-
//===========================================================================
qint AAS_EntityModelNum(qint entnum)
{
	if (!aasworld.initialized) return 0;
...
// Changes Globals:		-
//===========================================================================
qint AAS_OriginOfMoverWithModelNum(qint modelnum, vec3_t origin)
{
	qint i;
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
void AAS_EntitySize(qint entnum, vec3_t mins, vec3_t maxs)
{
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
void AAS_EntityBSPData(qint entnum, bsp_entdata_t *entdata)
{
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
qint AAS_NearestEntity(vec3_t origin, qint modelindex)
{
	qint i, bestentnum;
	float dist, bestdist;
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_BestReachableEntityArea(qint entnum)
{
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
qint AAS_NextEntity(qint entnum)
{
