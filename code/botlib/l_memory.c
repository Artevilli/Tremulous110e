...
//===========================================================================
#ifdef MEMDEBUG
void *GetMemoryDebug(size_t size, const qchar *label, const qchar *file, qint line)
#else
...
//===========================================================================
#ifdef MEMDEBUG
void *GetClearedMemoryDebug(size_t size, const qchar *label, const qchar *file, qint line)
#else
...
//===========================================================================
#ifdef MEMDEBUG
void *GetHunkMemoryDebug(size_t size, const qchar *label, const qchar *file, qint line)
#else
...
//===========================================================================
#ifdef MEMDEBUG
void *GetClearedHunkMemoryDebug(size_t size, const qchar *label, const qchar *file, qint line)
#else
...
// Changes Globals:		-
//===========================================================================
static memoryblock_t *BlockFromPointer(void *ptr, qchar *str)
{
	memoryblock_t *block;
	...
	{
#ifdef MEMDEBUG
		//qchar *crash = (qchar *) NULL;
		//crash[0] = 1;
		botimport.Print(PRT_FATAL, "%s: NULL pointer\n", str);
#endif // MEMDEBUG
		return NULL;
	} //end if
	block = (memoryblock_t *) ((qchar *) ptr - sizeof(memoryblock_t));
...
void FreeMemory(void *ptr)
{
	...
	memid = (uintptr_t *) ((qchar *) ptr - sizeof(*memid));
