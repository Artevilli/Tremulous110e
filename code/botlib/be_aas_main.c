...
// Changes Globals:		-
//===========================================================================
void QDECL AAS_Error(qchar *fmt, ...)
{
	qchar str[1024];
	va_list arglist;
...
void AAS_ContinueInit(float time)
{
	...
	if (aasworld.savefile || ((qint)LibVarGetValue("forcewrite")))
	{
		//optimize the AAS data
		if ((qint)LibVarValue("aasoptimize", "0")) AAS_Optimize();
		//save the AAS file
...
// Changes Globals:		-
//===========================================================================
qint AAS_StartFrame(float time)
{
	aasworld.time = time;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_LoadFiles(const qchar *mapname)
{
	qint errnum;
	qchar aasfile[MAX_PATH];
//	qchar bspfile[MAX_PATH];
...
// Changes Globals:		-
//===========================================================================
qint AAS_LoadMap(const qchar *mapname)
{
	qint	errnum;
