...
// Changes Globals:		-
//===========================================================================
static qint ReadValue(source_t *source, float *value)
{
	token_t token;
...
// Changes Globals:		-
//===========================================================================
static qint ReadFuzzyWeight(source_t *source, fuzzyseperator_t *fs)
{
...
{
	qint newindent, index, def, founddefault;
	token_t token;
...
// Changes Globals:		-
//===========================================================================
weightconfig_t *ReadWeightConfig(const qchar *filename)
{
	qint newindent, avail = 0, n;
	token_t token;
	source_t *source;
	fuzzyseperator_t *fs;
	...
	while(PC_ReadToken(source, &token))
	{
		if (!strcmp(token.string, "weight"))
		{
			...
			config->weights[config->numweights].name = (qchar *) GetClearedMemory(strlen(token.string) + 1);
...
// Changes Globals:		-
//===========================================================================
static qbool WriteFuzzyWeight(FILE *fp, fuzzyseperator_t *fs)
{
...
// Changes Globals:		-
//===========================================================================
static qbool WriteFuzzySeperators_r(FILE *fp, fuzzyseperator_t *fs, qint indent)
{
...
// Changes Globals:		-
//===========================================================================
qbool WriteWeightConfig(qchar *filename, weightconfig_t *config)
{
	qint i;
	FILE *fp;
	weight_t *ifw;
...
// Changes Globals:		-
//===========================================================================
qint FindFuzzyWeight(const weightconfig_t *wc, const qchar *name)
{
	qint i;
...
// Changes Globals:		-
//===========================================================================
static float FuzzyWeight_r(qint *inventory, fuzzyseperator_t *fs)
{
	float scale, w1, w2;
...
// Changes Globals:		-
//===========================================================================
static float FuzzyWeightUndecided_r(qint *inventory, fuzzyseperator_t *fs)
{
	float scale, w1, w2;
...
// Changes Globals:		-
//===========================================================================
float FuzzyWeight(qint *inventory, weightconfig_t *wc, qint weightnum)
{
...
// Changes Globals:		-
//===========================================================================
float FuzzyWeightUndecided(qint *inventory, weightconfig_t *wc, qint weightnum)
{
#ifdef EVALUATERECURSIVELY
...
// Changes Globals:		-
//===========================================================================
void ScaleWeight(weightconfig_t *config, qchar *name, float scale)
{
	qint i;
...
// Changes Globals:		-
//===========================================================================
static qint InterbreedFuzzySeperator_r(fuzzyseperator_t *fs1, fuzzyseperator_t *fs2,
