...
static qint debuglines[MAX_DEBUGLINES];
static qint debuglinevisible[MAX_DEBUGLINES];
static qint numdebuglines;

static qint debugpolygons[MAX_DEBUGPOLYGONS];
...
// Changes Globals:		-
//===========================================================================
static void AAS_ShowPolygon(qint color, qint numpoints, vec3_t *points)
{
	qint i;
...
// Changes Globals:		-
//===========================================================================
void AAS_DebugLine(vec3_t start, vec3_t end, qint color)
{
	qint line;
...
// Changes Globals:		-
//===========================================================================
void AAS_PermanentLine(vec3_t start, vec3_t end, qint color)
{
	qint line;
...
// Changes Globals:		-
//===========================================================================
void AAS_DrawPermanentCross(vec3_t origin, float size, qint color)
{
	qint i, debugline;
	vec3_t start, end;
...
// Changes Globals:		-
//===========================================================================
void AAS_DrawPlaneCross(vec3_t point, vec3_t normal, float dist, qint type, qint color)
{
	qint n0, n1, n2, j, line, lines[2];
...
// Changes Globals:		-
//===========================================================================
void AAS_ShowFace(qint facenum)
{
	qint i, color, edgenum;
	aas_edge_t *edge;
	aas_face_t *face;
	aas_plane_t *plane;
	vec3_t start, end;
...
// Changes Globals:		-
//===========================================================================
static void AAS_ShowFacePolygon(qint facenum, qint color, qint flip)
{
	qint i, edgenum, numpoints;
	vec3_t points[128];
	aas_edge_t *edge;
	aas_face_t *face;
...
// Changes Globals:		-
//===========================================================================
void AAS_ShowArea(qint areanum, qint groundfacesonly)
{
	qint areaedges[MAX_DEBUGLINES];
	qint numareaedges, i, j, n, color = 0, line;
	qint facenum, edgenum;
	aas_area_t *area;
	aas_face_t *face;
	aas_edge_t *edge;
...
// Changes Globals:		-
//===========================================================================
void AAS_ShowAreaPolygons(qint areanum, qint color, qint groundfacesonly)
{
	qint i, facenum;
	aas_area_t *area;
	aas_face_t *face;
...
// Changes Globals:		-
//===========================================================================
void AAS_DrawCross(vec3_t origin, float size, qint color)
{
	qint i;
	vec3_t start, end;
...
// Changes Globals:		-
//===========================================================================
void AAS_PrintTravelType(qint traveltype)
{
#ifdef DEBUG
	qchar *str;
	//
...
// Changes Globals:		-
//===========================================================================
void AAS_DrawArrow(vec3_t start, vec3_t end, qint linecolor, qint arrowcolor)
{
...
// Changes Globals:		-
//===========================================================================
void AAS_ShowReachableAreas(qint areanum)
{
	aas_areasettings_t *settings;
	static aas_reachability_t reach;
	static qint index, lastareanum;
...
static void AAS_FloodAreas_r(qint areanum, qint cluster, qint *done)
{
	qint nextareanum, i, facenum;
	aas_area_t *area;
	aas_face_t *face;
	aas_areasettings_t *settings;
...
{
	qint areanum, cluster, *done;

	done = (qint *) GetClearedMemory(aasworld.numareas * sizeof(qint));
