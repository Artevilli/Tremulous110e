...
// Changes Globals:		-
//===========================================================================
static qbool AAS_ClipToBBox( aas_trace_t *trace, const vec3_t start, const vec3_t end, qint presencetype, const vec3_t mins, const vec3_t maxs )
{
	qint i, j, side;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_ClientMovementPrediction( aas_clientmove_t *move,
								...
								qint stopevent, qint stopareanum,
								const vec3_t mins, const vec3_t maxs, qint visualize )
{
	...
	//qint ax;
	qint n, i, j, pc, step, swimming, crouch, event, jump_frame, areanum;
	qint areas[20], numareas;
	vec3_t points[20];
