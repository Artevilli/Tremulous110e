...
typedef struct optimized_s
{
	...
	aas_area_t *areas;
	//
	qint *vertexoptimizeindex;
	qint *edgeoptimizeindex;
	qint *faceoptimizeindex;
} optimized_t;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_KeepEdge(aas_edge_t *edge)
{
	return 1;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_OptimizeEdge(optimized_t *optimized, qint edgenum)
{
	qint i, optedgenum;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_KeepFace(aas_face_t *face)
{
...
// Changes Globals:		-
//===========================================================================
static qint AAS_OptimizeFace(optimized_t *optimized, qint facenum)
{
	qint i, edgenum, optedgenum, optfacenum;
...
// Changes Globals:		-
//===========================================================================
static void AAS_OptimizeArea(optimized_t *optimized, qint areanum)
{
	qint i, facenum, optfacenum;
...
static void AAS_OptimizeAlloc(optimized_t *optimized)
{
	...
	//
	optimized->vertexoptimizeindex = (qint *) GetClearedMemory(aasworld.numvertexes * sizeof(qint));
	optimized->edgeoptimizeindex = (qint *) GetClearedMemory(aasworld.numedges * sizeof(qint));
	optimized->faceoptimizeindex = (qint *) GetClearedMemory(aasworld.numfaces * sizeof(qint));
