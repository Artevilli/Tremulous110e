...
typedef struct bot_initmove_s
{
	...
	qint or_moveflags;			//values ored to the movement flags
} bot_initmove_t;

//NOTE: the ideal_viewangles are only valid if MFL_MOVEMENTVIEW is set
typedef struct bot_moveresult_s
{
	qint failure;				//true if movement failed all together
	qint type;					//failure or blocked type
	qint blocked;				//true if blocked by an entity
	qint blockentity;			//entity blocking the bot
	qint traveltype;				//last executed travel type
	qint flags;					//result flags
	qint weapon;					//weapon used for movement
