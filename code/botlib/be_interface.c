...
// Changes Globals:		-
//===========================================================================
static qbool ValidEntityNumber(qint num, const qchar *str)
{
...
// Changes Globals:		-
//===========================================================================
static qbool BotLibSetup(const qchar *str)
{
...
// Changes Globals:		-
//===========================================================================
static qint Export_BotLibSetup( void )
{
	qint		errnum;
...
// Changes Globals:		-
//===========================================================================
static qint Export_BotLibShutdown(void)
{
	if ( !botlibglobals.botlibsetup )
...
// Changes Globals:		-
//===========================================================================
static qint Export_BotLibVarSet( const qchar *var_name, const qchar *value )
{
...
// Changes Globals:		-
//===========================================================================
static qint Export_BotLibVarGet( const qchar *var_name, qchar *value, qint size )
{
	const qchar *varvalue;
...
// Changes Globals:		-
//===========================================================================
static qint Export_BotLibStartFrame(float time)
{
...
// Changes Globals:		-
//===========================================================================
static qint Export_BotLibLoadMap(const qchar *mapname)
{
#ifdef DEBUG
...
// Changes Globals:		-
//===========================================================================
static qint Export_BotLibUpdateEntity(qint ent, bot_entitystate_t *state)
{
...
//===========================================================================
#if 0
void AAS_TestMovementPrediction(qint entnum, vec3_t origin, vec3_t dir);
#endif
...
qint AAS_PointLight(vec3_t origin, qint *red, qint *green, qint *blue);
...
float BotGapDistance(vec3_t origin, vec3_t hordir, qint entnum);

void AAS_FloodAreas(vec3_t origin);

qint BotExportTest(qint parm0, qchar *parm1, vec3_t parm2, vec3_t parm3)
{
...
//	return AAS_PointLight(parm2, NULL, NULL, NULL);
	...
	static qint area = -1;
	static qint line[2];
	qint newarea, i, highlightarea, flood;
//	qint reachnum;
...
/*	face = AAS_AreaGroundFace(newarea, parm2);
	...
	*/
	...
	{
		static qint lastgoalareanum, lastareanum;
		static qint avoidreach[MAX_AVOIDREACH];
		static float avoidreachtimes[MAX_AVOIDREACH];
		static qint avoidreachtries[MAX_AVOIDREACH];
		qint reachnum, resultFlags;
		bot_goal_t goal;
		aas_reachability_t reach;
