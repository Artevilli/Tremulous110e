...
//===========================================================================
#if 0
void AAS_ClearCluster(qint clusternum)
{
	qint i;
...
// Changes Globals:		-
//===========================================================================
void AAS_RemovePortalsClusterReference(qint clusternum)
{
	qint portalnum;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_UpdatePortal(qint areanum, qint clusternum)
{
	qint portalnum;
	aas_portal_t *portal;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_FloodClusterAreas_r(qint areanum, qint clusternum)
{
	aas_area_t *area;
	aas_face_t *face;
	qint facenum, i;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_FloodClusterAreasUsingReachabilities(qint clusternum)
{
	qint i, j, areanum;
...
// Changes Globals:		-
//===========================================================================
static void AAS_NumberClusterPortals(qint clusternum)
{
	qint i, portalnum;
	aas_cluster_t *cluster;
	aas_portal_t *portal;
...
// Changes Globals:		-
//===========================================================================
static void AAS_NumberClusterAreas(qint clusternum)
{
	qint i, portalnum;
	aas_cluster_t *cluster;
	aas_portal_t *portal;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_FindClusters(void)
{
	qint i;
	aas_cluster_t *cluster;
...
// Changes Globals:		-
//===========================================================================
qint AAS_MapContainsTeleporters(void)
{
...
// Changes Globals:		-
//===========================================================================
qint AAS_NonConvexFaces(aas_face_t *face1, aas_face_t *face2, qint side1, qint side2)
{
	qint i, j, edgenum;
...
// Changes Globals:		-
//===========================================================================
qbool AAS_CanMergeAreas(qint *areanums, qint numareas)
{
	qint i, j, s, face1num, face2num, side1, side2, fn1, fn2;
...
// Changes Globals:		-
//===========================================================================
qbool AAS_NonConvexEdges(aas_edge_t *edge1, aas_edge_t *edge2, qint side1, qint side2, qint planenum)
{
	qint i;
...
// Changes Globals:		-
//===========================================================================
qbool AAS_CanMergeFaces(qint *facenums, qint numfaces, qint planenum)
{
	qint i, j, s, edgenum1, edgenum2, side1, side2, en1, en2, ens;
...
// Changes Globals:		-
//===========================================================================
static void AAS_ConnectedAreas_r(qint *areanums, qint numareas, qint *connectedareas, qint curarea)
{
	qint i, j, otherareanum, facenum;
	aas_area_t *area;
	aas_face_t *face;
...
// Changes Globals:		-
//===========================================================================
static qbool AAS_ConnectedAreas(qint *areanums, qint numareas)
{
	qint connectedareas[MAX_PORTALAREAS], i;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_GetAdjacentAreasWithLessPresenceTypes_r(qint *areanums, qint numareas, qint curareanum)
{
	qint i, j, presencetype, otherpresencetype, otherareanum, facenum;
	aas_area_t *area;
	aas_face_t *face;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_CheckAreaForPossiblePortals(qint areanum)
{
	qint i, j, k, fen, ben, frontedgenum, backedgenum, facenum;
	qint areanums[MAX_PORTALAREAS], numareas, otherareanum;
	qint numareafrontfaces[MAX_PORTALAREAS], numareabackfaces[MAX_PORTALAREAS];
	qint frontfacenums[MAX_PORTALAREAS], backfacenums[MAX_PORTALAREAS];
	qint numfrontfaces, numbackfaces;
	qint frontareanums[MAX_PORTALAREAS], backareanums[MAX_PORTALAREAS];
	qint numfrontareas, numbackareas;
	qint frontplanenum, backplanenum, faceplanenum;
	aas_area_t *area;
...
// Changes Globals:		-
//===========================================================================
void AAS_FloodCluster_r(qint areanum, qint clusternum)
{
	qint i, otherareanum;
	aas_face_t *face;
	aas_area_t *area;
...
// Changes Globals:		-
//===========================================================================
void AAS_FloodClusterReachabilities(qint clusternum)
{
	qint i, j, areanum;
...
{
	qint i, j, k, facenum, otherareanum, nonclosingportals;
	aas_area_t *area;
	aas_face_t *face;
...
void AAS_RemoveNotClusterClosingPortals(void)
{
	qint i, j, facenum, otherareanum, nonclosingportals, numseperatedclusters;
	aas_area_t *area;
	aas_face_t *face;
...
{
	qint j, area2num, facenum, otherareanum;
	qchar *target, *targetname, *classname;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_TestPortals(void)
{
	qint i;
	aas_portal_t *portal;
...
{
	qint i, removedPortalAreas;
	qint n, total, numreachabilityareas;
	...
	if (aasworld.numclusters >= 1)
	{
		...
		if (!((qint)LibVarGetValue("forceclustering")) &&
			!((qint)LibVarGetValue("forcereachability"))) return;
#endif
	} //end if
