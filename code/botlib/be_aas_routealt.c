...
static qint *clusterareas;
static qint numclusterareas;
...
// Changes Globals:		-
//===========================================================================
static void AAS_AltRoutingFloodCluster_r(qint areanum)
{
	qint i, otherareanum;
	aas_area_t *area;
	aas_face_t *face;
...
qint AAS_AlternativeRouteGoals(vec3_t start, qint startareanum, vec3_t goal, qint goalareanum, qint travelflags,
										 aas_altroutegoal_t *altroutegoals, qint maxaltroutegoals,
										 qint type)
{
#ifndef ENABLE_ALTROUTING
	return 0;
#else
	qint i, j, bestareanum;
	qint numaltroutegoals, nummidrangeareas;
	qint starttime, goaltime, goaltraveltime;
	float dist, bestdist;
	vec3_t mid, dir;
...
void AAS_InitAlternativeRouting(void)
{
	...
	clusterareas = (qint *) GetMemory(aasworld.numareas * sizeof(qint));
#endif
