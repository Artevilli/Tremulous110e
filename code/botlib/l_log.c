...
{
	qchar filename[MAX_LOGFILENAMESIZE];
	FILE *fp;
	qint numwrites;
} logfile_t;
...
// Changes Globals:		-
//===========================================================================
void Log_Open( const qchar *filename )
{
	const qchar *ospath;
...
// Changes Globals:		-
//===========================================================================
void QDECL Log_Write(qchar *fmt, ...)
{
	va_list ap;
...
// Changes Globals:		-
//===========================================================================
void QDECL Log_WriteTimeStamped(qchar *fmt, ...)
{
	va_list ap;
	...
	fprintf(logfile.fp, "%d   %02d:%02d:%02d:%02d   ",
					logfile.numwrites,
					(qint) (botlibglobals.time / 60 / 60),
					(qint) (botlibglobals.time / 60),
					(qint) (botlibglobals.time),
					(qint) ((qint) (botlibglobals.time * 100)) -
							((qint) botlibglobals.time) * 100);
	va_start(ap, fmt);
	vfprintf(logfile.fp, fmt, ap);
	va_end(ap);
	fprintf(logfile.fp, "\r\n");
