...
{
	qchar string[MAX_TOKEN];			//available token
...
typedef struct script_s
{
	...
	qchar *endwhitespace_p;			//end of the white space
...
void QDECL ScriptError(script_t *script, const qchar *fmt, ...) __attribute__ ((format (printf, 2, 3)));
