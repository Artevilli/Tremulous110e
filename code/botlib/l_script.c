...
#ifdef BSPC
static qchar basefolder[MAX_PATH];
#else
static qchar basefolder[MAX_QPATH];
#endif
...
// Changes Globals:		-
//===========================================================================
const qchar *PunctuationFromNum(script_t *script, qint num)
{
	qint i;
...
// Changes Globals:		-
//===========================================================================
void QDECL ScriptError(script_t *script, const qchar *fmt, ...)
{
	qchar text[1024];
	va_list ap;
...
// Changes Globals:		-
//===========================================================================
static void QDECL ScriptWarning(script_t *script, const qchar *fmt, ...)
{
	qchar text[1024];
	va_list ap;
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadWhiteSpace(script_t *script)
{
	while(1)
	{
		//skip white space
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadEscapeCharacter(script_t *script, qchar *ch)
{
	qint c, val;
	...
	switch(*script->script_p)
	{
		...
		{
			if (*script->script_p < '0' || *script->script_p > '9') ScriptError(script, "unknown escape qchar");
			for (val = 0; ;script->script_p++)
			{
				c = *script->script_p;
				if (c >= '0' && c <= '9')
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadString(script_t *script, token_t *token, qint quote)
{
	qint len, tmpline;
	qchar *tmpscript_p;
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadName(script_t *script, token_t *token)
{
	qint len = 0;
	qchar c;
...
// Changes Globals:		-
//============================================================================
static void NumberValue(qchar *string, qint subtype, unsigned long qint *intvalue,
															float *floatvalue)
{
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadNumber(script_t *script, token_t *token)
{
	qint len = 0, i;
	qint octal, dot;
	qchar c;
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadLiteral(script_t *script, token_t *token)
{
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadPunctuation(script_t *script, token_t *token)
{
	qint len;
	const qchar *p;
	punctuation_t *punc;
...
// Changes Globals:		-
//============================================================================
static qint PS_ReadPrimitive(script_t *script, token_t *token)
{
	qint len;
...
// Changes Globals:		-
//============================================================================
qint PS_ReadToken(script_t *script, token_t *token)
{
...
// Changes Globals:		-
//============================================================================
qint PS_ExpectTokenString(script_t *script, const qchar *string)
{
	token_t token;
...
// Changes Globals:		-
//============================================================================
qint PS_ExpectTokenType(script_t *script, qint type, qint subtype, token_t *token)
{
	qchar str[MAX_TOKEN];
...
// Changes Globals:		-
//============================================================================
qint PS_ExpectAnyToken(script_t *script, token_t *token)
{
	if (!PS_ReadToken(script, token))
	{
		ScriptError(script, "couldn't read expected token");
...
// Changes Globals:		-
//============================================================================
qint PS_CheckTokenString(script_t *script, const qchar *string)
{
	token_t tok;
...
// Changes Globals:		-
//============================================================================
qint PS_CheckTokenType(script_t *script, qint type, qint subtype, token_t *token)
{
	token_t tok;
...
// Changes Globals:		-
//============================================================================
qint PS_SkipUntilString(script_t *script, const qchar *string)
{
	token_t token;
...
// Changes Globals:		-
//============================================================================
qchar PS_NextWhiteSpaceChar(script_t *script)
{
...
// Changes Globals:		-
//============================================================================
void StripDoubleQuotes(qchar *string)
{
	if (*string == '\"')
	{
...
// Changes Globals:		-
//============================================================================
void StripSingleQuotes(qchar *string)
{
	if (*string == '\'')
	{
		memmove(string, string+1, strlen(string));
...
// Changes Globals:		-
//============================================================================
signed long qint ReadSignedInt(script_t *script)
{
	token_t token;
	signed long qint sign = 1;
...
// Changes Globals:		-
//============================================================================
void SetScriptFlags(script_t *script, qint flags)
{
	script->flags = flags;
...
// Changes Globals:		-
//============================================================================
qint GetScriptFlags(script_t *script)
{
	return script->flags;
...
// Changes Globals:		-
//============================================================================
qint EndOfScript(script_t *script)
{
...
// Changes Globals:		-
//============================================================================
qint NumLinesCrossed(script_t *script)
{
...
// Changes Globals:		-
//============================================================================
qint ScriptSkipTo(script_t *script, qchar *value)
{
	qint len;
	qchar firstchar;
...
// Changes Globals:		-
//============================================================================
static qint FileLength(FILE *fp)
{
	qint pos;
	qint end;
...
// Changes Globals:		-
//============================================================================
script_t *LoadScriptFile(const qchar *filename)
{
#ifdef BOTLIB
	fileHandle_t fp;
	qchar pathname[MAX_QPATH*2];
#else
	FILE *fp;
#endif
	qint length;
...
// Changes Globals:		-
//============================================================================
script_t *LoadScriptMemory(const qchar *ptr, qint length, const qchar *name)
{
	void *buffer;
	script_t *script;
...
// Changes Globals:		-
//============================================================================
void PS_SetBaseFolder( const qchar *path )
{
