...
// Changes Globals:		-
//===========================================================================
static float LibVarStringValue( const qchar *string )
{
	qint dotfound = 0;
	float value = 0;
...
// Changes Globals:		-
//===========================================================================
libvar_t *LibVarAlloc( const qchar *var_name )
{
	libvar_t *v;

	v = (libvar_t *) GetMemory( sizeof( libvar_t ) );
	Com_Memset( v, 0, sizeof( libvar_t ) );
	v->name = (qchar *) GetMemory( strlen( var_name )+1 );
...
libvar_t *LibVar( const qchar *var_name, const qchar *value )
{
	...
	//variable string
	v->string = (qchar *) GetMemory( strlen( value ) + 1 );
...
{
	qint v = (qint) LibVarValue(var_name, value);
