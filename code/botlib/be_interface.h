...
{
	qint botlibsetup;						//true when the bot library has been setup
	qint maxentities;						//maximum number of entities
	qint maxclients;							//maximum number of clients
...
extern qint botDeveloper;					//true if developer is on
