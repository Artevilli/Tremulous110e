...
typedef struct aas_tracestack_s
{
	...
	qint planenum;		//last plane used as splitter
	qint nodenum;		//node found after splitting with planenum
} aas_tracestack_t;

static qint numaaslinks;
...
// Changes Globals:		-
//===========================================================================
qint AAS_PointReachabilityAreaIndex( vec3_t origin )
{
	qint areanum, cluster, i, index;
...
// Changes Globals:		-
//===========================================================================
vec_t AAS_BoxOriginDistanceFromPlane(vec3_t normal, vec3_t mins, vec3_t maxs, qint side)
{
	vec3_t v1, v2;
	qint i;
...
// Changes Globals:		-
//===========================================================================
static qbool AAS_AreaEntityCollision(qint areanum, vec3_t start, vec3_t end,
										qint presencetype, qint passent, aas_trace_t *trace)
{
	qint collision;
...
// Changes Globals:		-
//===========================================================================
aas_trace_t AAS_TraceClientBBox(vec3_t start, vec3_t end, qint presencetype,
																				qint passent)
{
	qint side, nodenum, tmpplanenum;
...
// Changes Globals:		-
//===========================================================================
static qbool AAS_InsideFace(aas_face_t *face, vec3_t pnormal, vec3_t point, float epsilon)
{
	qint i, firstvertex, edgenum;
	vec3_t v0;
...
// Changes Globals:		-
//===========================================================================
static qint AAS_BoxOnPlaneSide2(vec3_t absmins, vec3_t absmaxs, aas_plane_t *p)
{
	qint i, sides;
	float dist1, dist2;
	vec3_t corners[2];
...
// Changes Globals:		-
//===========================================================================
//qint AAS_BoxOnPlaneSide(vec3_t absmins, vec3_t absmaxs, aas_plane_t *p)
...
typedef struct
{
	qint nodenum;		//node found after splitting
} aas_linkstack_t;
