...
//field types
#define FT_CHAR						1			// qchar
#define FT_INT							2			// qint
#define FT_FLOAT						3			// float
#define FT_STRING						4			// qchar [MAX_STRINGFIELD]
...
{
	const qchar *name;										//name of the field
	qint offset;										//offset in the structure
	qint type;										//type of the field
	//type specific fields
	qint maxarray;									//maximum array size
