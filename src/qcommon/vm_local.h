...
vm_s
{
  ...
  const qchar *name; //module should be bare: "cgame", not "cgame.dll" or "vm/cgame.qvm"
  vmIndex_t index;
  ...
  vmFunc_t codeBase;
  unsigned codeSize; //code + jump targets, needed for proper munmap()
  unsigned codeLength; //just for information
