...
Sys_SteamPath(void)
{
  static qchar steamPath[MAX_OSPATH];
  //disabled since Steam doesn't let you install Quake 3 on Mac/Linux, and I don't know if Tremulous will do the same if/when it gets put on Steam
#if 0
  const qchar *p;
  ...
  {
#if defined(MACOS_X)
    qchar *steamPathEnd = "/Library/Application Support/Steam/SteamApps/common/" STEAMPATH_NAME;
#else
    qchar *steamPathEnd = "/.steam/steam/SteamApps/common/" STEAMPATH_NAME;
#endif
